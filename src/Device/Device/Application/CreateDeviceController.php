...
use CTIC\Device\Device\Infrastructure\Controller\DeviceController;
use CTIC\Device\Device\Infrastructure\Form\Type\DeviceType;
...
class CreateDeviceController extends CreateResourceController
{
    /**
    ...
    ): void
    {
        ...
        $formRegistry->addType(new DeviceType(Device::class));
    }
        ...
        if(empty($command->metadata))
        {
            $command->metadata = self::getMetadata(
                ...
                array(
                    ...
                    'classes'       => array(
                        'form'      => 'CTIC\Device\Device\Infrastructure\Form\Type\DeviceType'
                    ),
                    'grid'          => array(
                        'actionGroups'  => array(
                            'bulk'  => array(
    ...
    public static function setDefaultCommand(ResourceControllerCommand $command): void
    {
        if(empty($command->newResourceFactory))
        {
            $command->newResourceFactory = new CreateDevice();
        }
        if(empty($command->resource))
        {
            $command->resource = Device::class;
        }
        if(empty($command->command))
        {
            $command->command = new DeviceCommand();
        }
    }
